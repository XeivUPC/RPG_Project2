...
TitleMenuCG::TitleMenuCG(UICanvas& _settingsReference) : settingsReference(&_settingsReference)
{
	...
	float btnScale = 1.5f;
	Vector2Int btnSize = { 57,23 };

	UITextBox* startNewGame_text = new UITextBox("New Game", *textFont, 16, { 184,132,78,255 }, anchorPoint + Vector2Int{ 0,-75 + (int)btnScale }, btnSize* btnScale, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* startNewGame_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{0,-75}, btnSize, { 0,0,57,23 }, { 0.5f,0.5f });
	...
	UITextBox* continueGame_text = new UITextBox("Continue", *textFont, 16, { 184,132,78,255 }, anchorPoint + Vector2Int{ 0,-25 + (int)btnScale }, btnSize * btnScale, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* continueGame_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{ 0,-25 }, btnSize, { 0,0,57,23 }, { 0.5f,0.5f });
	...
	UITextBox* settings_text = new UITextBox("Settings", *textFont, 16, { 184,132,78,255 }, anchorPoint + Vector2Int{ 0,25 + (int)btnScale }, btnSize * btnScale, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	...
	UITextBox* exit_text = new UITextBox("Exit", *textFont, 16, { 184,132,78,255 }, anchorPoint + Vector2Int{ 0,75 + (int)btnScale }, btnSize * btnScale, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* exit_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{ 0,75}, btnSize, { 0,0,57,23 }, { 0.5f,0.5f });
