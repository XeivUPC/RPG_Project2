...
TitleMenuCG::TitleMenuCG(UICanvas& _settingsReference) : settingsReference(&_settingsReference)
{
	...
	UITextBox* startNewGame_text = new UITextBox("New Game", *textFont, 32, { 27,34,54,255 }, anchorPoint + Vector2Int{ 0,-150 }, { 57 * 3,23 * 3 }, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* startNewGame_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{0,-150}, { 57,23 }, { 0,4,57,23 }, { 0.5f,0.5f });
	...
	UITextBox* continueGame_text = new UITextBox("Continue", *textFont, 32, { 27,34,54,255 }, anchorPoint + Vector2Int{ 0,-50 }, { 57 * 3,23 * 3 }, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* continueGame_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{ 0,-50 }, { 57,23 }, { 0,4,57,23 }, { 0.5f,0.5f });
	...
	UITextBox* settings_text = new UITextBox("Settings", *textFont, 32, { 27,34,54,255 }, anchorPoint + Vector2Int{ 0,50 }, { 57 * 3,23 * 3 }, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* settings_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{ 0,50 }, { 57,23 }, { 0,4,57,23 }, { 0.5f,0.5f });
	...
	UITextBox* exit_text = new UITextBox("Exit", *textFont, 32, { 27,34,54,255 }, anchorPoint + Vector2Int{ 0,150 }, { 57 * 3,23 * 3 }, { 0.5f,0.5f }, UITextBox::HorizontalAlignment::Middle, UITextBox::VerticalAlignment::Middle);
	UIButton* exit_btn = new UIButton(*btn_texture, anchorPoint + Vector2Int{ 0,150}, { 57,23 }, { 0,4,57,23 }, { 0.5f,0.5f });
